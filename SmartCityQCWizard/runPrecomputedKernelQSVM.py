...
try:
    ...
    kernel_train, kernel_test = np.load(open(f"kernels/precomputedKernel_{random_seed}_{n_components}_{windowSizeX}.npy", 'rb')).values()
except:
    ...
    np.savez(open(f"kernels/precomputedKernel_{random_seed}_{n_components}_{windowSizeX}.npy", 'wb'), kernel_train=kernel_train, kernel_test=kernel_test)
