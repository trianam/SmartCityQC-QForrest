...
def run(datasetFile, xColumns, yColumns, windowSizeX, windowSizeY, splitSeed, usePrecomputedKernel, parallelizeKernel, singleSplit, circuit, returnMF1):
    ...
    if usePrecomputedKernel:
        precomputedKernelFilename = f"precomputedKernel_seed-{splitSeed}_circ-{circuit}_columns-{len(xColumns)}_wSizeX-{windowSizeX}_wSizeY-{windowSizeY}.npy"
...
if __name__ == "__main__":
    ...
    run(datasetFile, xColumns, yColumns, windowSizeX, windowSizeY, splitSeed, usePrecomputedKernel, parallelizeKernel, singleSplit, circuit, returnMF1)
